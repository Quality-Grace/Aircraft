...
public class CombatTutorial extends Display {
    ...
    public void render(Screen screen) {
        ...
        for (int y = 0; y < 1; y++) {
            for (int x = 0; x < 1; x++) {
                screen.render(79 + x * 8, 155 + y * 8, new Sprite.Px(x + 4, y + 2, 0, 3)); // Player hit sprite
                                                                                           // (half-up)
            }
        }
        ...
        for (int y = 0; y < 1; y++) {
            for (int x = 0; x < 1; x++) {
                screen.render(79 + x * 8, 163 + y * 8, new Sprite.Px(x + 4, y + 2, 2, 3)); // Player hit sprite
                                                                                           // (half-down)
            }
        }
        ...
        /*
         * for (int y = 0; y < 1; y++) { for (int x = 0; x < 1; x++) { screen.render(79
         * + x * 8, 224 + y * 8, new Sprite.Px(x + 4 , y + 2, 0, 3)); // Player hit
         * sprite (half-up) } }
         * 
         * for (int y = 0; y < 1; y++) { for (int x = 0; x < 1; x++) { screen.render(79
         * + x * 8, 232 + y * 8, new Sprite.Px(x + 4 , y + 2, 2, 3)); // Player hit
         * sprite (half-down) } }
         */
        ...
        /*
         * int h = 1; int w = 1; int xo = 175; int yo = 232;
         * 
         * for (int y = 0; y < h; y++) { for (int x = 0; x < w; x++) { screen.render(xo
         * + x * 8, yo + y * 8, new Sprite.Px(x + 16 , y, 0, 0)); // Apple } }
         */
