...
public class Renderer extends Game {
	...
	private static void renderGamePlay(){
	...
	private static void renderGui() {
		...
		if (player.activeItem instanceof ToolItem) {
			...
			renderArrowCountStatus(tool);
			renderToolDurabilityStatus(tool);
		}
	...
	public static void renderStatusIcons(){
		if (!isMode("Creative")) {
			...
			for (int i = 0; i < Player.maxStat; i++) {
				...
				// Renders your Stamina Icons
				renderStatimaIcons(i);

				// Renders your hunger icons
				renderHungerIcons(i);
	...
	public static void renderArmorIcons(int i){
	...
	public static void renderHungerIcons(int i){
		if (i < player.hunger) {
	...
	public static void renderStatimaIcons(int i){
	...
	public static void renderHeartIcons(int i){
	...
	public static void renderPotionsOverlay(){
	...
	public static void renderNotifications(ArrayList<String> permStatus){
		/// NOTIFICATIONS
	...
	public static void renderToolDurabilityStatus(ToolItem tool){
	...
	public static void renderArrowCountStatus(ToolItem tool){
		// ARROWS COUNT STATUS
