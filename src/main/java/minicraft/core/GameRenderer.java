...
public class GameRenderer extends Renderer {
    ...
    private static void renderStatusIcons(){
        if (!isMode("Creative")) {
    ...
    private static void renderArmorIcons(int i){
    ...
    private static void renderHungerIcons(int i){
        if (i < player.hunger) {
    ...
    private static void renderStatimaIcons(int i){
    ...
    private static void renderHeartIcons(int i){
    ...
    private static void renderPotionsOverlay(){
    ...
    private static void renderToolDurabilityStatus(ToolItem tool){
    ...
    private static void renderArrowCountStatus(ToolItem tool){
        // ARROWS COUNT STATUS
    ...
    private static void renderBossbar(int barLength, String title) {
        if (!showDebugInfo) {
            int x = (Screen.w / 4) + 4;
            int y = (Screen.h / 8) - 27;
